...
CREATE TABLE `qna_sub_category` (
  ...
  KEY `FK_qna_Category_TO_qna_Sub_Category_1` (`qs_qc_category`)
...
INSERT INTO `qna_sub_category` VALUES ('건의 요청','사이트 이용 문의'),('이용오류','사이트 이용 문의'),('결제','상품 관련 문의'),('상품 기타','상품 관련 문의'),('예약','상품 관련 문의');
