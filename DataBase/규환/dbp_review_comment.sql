...
CREATE TABLE `review_comment` (
  ...
  PRIMARY KEY (`rc_num`),
  KEY `FK_review_TO_review_comment_1` (`rc_re_num`),
  KEY `FK_member_TO_review_comment_1` (`rc_me_id`),
  CONSTRAINT `FK_member_TO_review_comment_1` FOREIGN KEY (`rc_me_id`) REFERENCES `member` (`me_id`),
  CONSTRAINT `FK_review_TO_review_comment_1` FOREIGN KEY (`rc_re_num`) REFERENCES `review` (`re_num`)
...
-- Dump completed on 2023-05-01 20:22:54
