...
CREATE TABLE `festival_option` (
  ...
  PRIMARY KEY (`fo_num`),
  KEY `FK_product_TO_festival_option_1` (`fo_pd_num`),
  CONSTRAINT `FK_product_TO_festival_option_1` FOREIGN KEY (`fo_pd_num`) REFERENCES `product` (`pd_num`)
...
INSERT INTO `festival_option` VALUES (1,30000,'성인',3),(2,15000,'유아',3),(3,5000,'유공자',3);
