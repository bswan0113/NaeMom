...
--
-- Host: localhost    Database: naemom
-- ------------------------------------------------------
...
INSERT INTO `accomodation_option` VALUES (1,'124',124,41,'41','41',8);
...
INSERT INTO `festival_option` VALUES (1,345,'345',8);
...
CREATE TABLE `file` (
  ...
  `fi_category` varchar(20) NOT NULL,
...
--
-- Table structure for table `hash-tag`
--

DROP TABLE IF EXISTS `hash-tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `hash-tag`
--

LOCK TABLES `hash-tag` WRITE;
/*!40000 ALTER TABLE `hash-tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `hash-tag` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `landmark_option` VALUES (1,10000,'3412',8);
...
CREATE TABLE `member` (
  ...
  KEY `me_ma_email_idx` (`me_ma_email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `q&a _sub_category`
--

DROP TABLE IF EXISTS `q&a _sub_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `q&a _sub_category` (
...
--
-- Dumping data for table `q&a _sub_category`
--

LOCK TABLES `q&a _sub_category` WRITE;
/*!40000 ALTER TABLE `q&a _sub_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `q&a _sub_category` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `reservated-option`
--

DROP TABLE IF EXISTS `reservated-option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `reservated-option` (
...
--
-- Dumping data for table `reservated-option`
--

LOCK TABLES `reservated-option` WRITE;
/*!40000 ALTER TABLE `reservated-option` DISABLE KEYS */;
/*!40000 ALTER TABLE `reservated-option` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `reservation-possible`
--

DROP TABLE IF EXISTS `reservation-possible`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `reservation-possible` (
...
--
-- Dumping data for table `reservation-possible`
--

LOCK TABLES `reservation-possible` WRITE;
/*!40000 ALTER TABLE `reservation-possible` DISABLE KEYS */;
/*!40000 ALTER TABLE `reservation-possible` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `reservation-room`
--

DROP TABLE IF EXISTS `reservation-room`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `reservation-room`
--

LOCK TABLES `reservation-room` WRITE;
/*!40000 ALTER TABLE `reservation-room` DISABLE KEYS */;
/*!40000 ALTER TABLE `reservation-room` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `restraunt_option` VALUES (1,'412',142,'412',8),(2,'243',4242,'24',5);
...
--
-- Table structure for table `review comment`
--

DROP TABLE IF EXISTS `review comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `review comment`
--

LOCK TABLES `review comment` WRITE;
/*!40000 ALTER TABLE `review comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `review comment` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database 'naemom'
--

--
-- Dumping routines for database 'naemom'
--
...
-- Dump completed on 2023-05-14  8:14:32
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
